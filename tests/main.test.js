...
test.skip('handles relative paths', async () => {
...
test.skip('handles JS errors', async () => {
  expect.assertions(1);
  try {
...
test.skip('handles 404 CSS file', async () => {
  expect.assertions(1);
  try {
...
test.skip('media queries print removed', async () => {
...
test.skip('removes unused @fontface', async () => {
...
test.skip('ignoreCSSErrors', async () => {
...
test.skip('handles 307 HTML file', async () => {
  const { finalCss } = await runMinimalcss('307');
  expect(finalCss).toEqual('p{color:violet}');
});

test.skip("deliberately skipped .css shouldn't error", async () => {
...
test.skip('order matters in badly repeated style sheets', async () => {
...
test.skip('accept CSSO options', async () => {
  const cssoOptions = {};
...
test.skip('timeout error for page', async () => {
  expect.assertions(2);
  try {
...
test.skip('timeout error for resources', async () => {
  expect.assertions(2);
  try {
